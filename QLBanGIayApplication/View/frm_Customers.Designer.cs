namespace QLBanGiay_Application.View
{
    partial class frm_Customers
    {
		...
		private void InitializeComponent()
		{
			...
			txt_Tenkhachhang = new Guna.UI2.WinForms.Guna2TextBox();
			guna2HtmlLabel3 = new Guna.UI2.WinForms.Guna2HtmlLabel();
			guna2HtmlLabel2 = new Guna.UI2.WinForms.Guna2HtmlLabel();
			txt_Makh = new Guna.UI2.WinForms.Guna2TextBox();
			...
			dgv_danhsachkh = new Guna.UI2.WinForms.Guna2DataGridView();
			groupBox1.SuspendLayout();
			groupBox2.SuspendLayout();
			groupBox3.SuspendLayout();
			groupBox4.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)dgv_danhsachkh).BeginInit();
			SuspendLayout();
			// 
			// groupBox1
			// 
			...
			txt_TenTK.Location = new Point(247, 56);
			...
			txt_TenTK.Size = new Size(169, 32);
			...
			txt_Email.Location = new Point(26, 317);
			...
			txt_Email.Size = new Size(393, 32);
			...
			txt_SDT.Location = new Point(236, 250);
			...
			cmbGender.Size = new Size(176, 36);
			...
			// txt_Tenkhachhang
			// 
			txt_Tenkhachhang.BorderColor = Color.FromArgb(0, 192, 192);
			txt_Tenkhachhang.CustomizableEdges = customizableEdges16;
			txt_Tenkhachhang.DefaultText = "";
			txt_Tenkhachhang.DisabledState.BorderColor = Color.FromArgb(208, 208, 208);
			txt_Tenkhachhang.DisabledState.FillColor = Color.FromArgb(226, 226, 226);
			txt_Tenkhachhang.DisabledState.ForeColor = Color.FromArgb(138, 138, 138);
			txt_Tenkhachhang.DisabledState.PlaceholderForeColor = Color.FromArgb(138, 138, 138);
			txt_Tenkhachhang.FocusedState.BorderColor = Color.FromArgb(94, 148, 255);
			txt_Tenkhachhang.Font = new Font("Segoe UI", 9F);
			txt_Tenkhachhang.HoverState.BorderColor = Color.FromArgb(94, 148, 255);
			txt_Tenkhachhang.Location = new Point(26, 120);
			txt_Tenkhachhang.Name = "txt_Tenkhachhang";
			txt_Tenkhachhang.PasswordChar = '\0';
			txt_Tenkhachhang.PlaceholderText = "";
			txt_Tenkhachhang.SelectedText = "";
			txt_Tenkhachhang.ShadowDecoration.CustomizableEdges = customizableEdges17;
			txt_Tenkhachhang.Size = new Size(389, 32);
			txt_Tenkhachhang.TabIndex = 9;
			// 
			// guna2HtmlLabel3
			// 
			...
			guna2HtmlLabel3.Size = new Size(115, 23);
			...
			guna2HtmlLabel2.Size = new Size(99, 23);
			guna2HtmlLabel2.TabIndex = 3;
			guna2HtmlLabel2.Text = "Tên tài khoản:";
			// 
			// txt_Makh
			// 
			txt_Makh.BorderColor = Color.FromArgb(0, 192, 192);
			txt_Makh.CustomizableEdges = customizableEdges18;
			txt_Makh.DefaultText = "";
			txt_Makh.DisabledState.BorderColor = Color.FromArgb(208, 208, 208);
			...
			txt_Makh.Location = new Point(26, 56);
			...
			guna2HtmlLabel1.Size = new Size(112, 23);
			...
			btn_Thoat.CustomizableEdges = customizableEdges20;
			...
			btn_Thoat.ShadowDecoration.CustomizableEdges = customizableEdges21;
			...
			// btn_Reset
			// 
			btn_Reset.CustomizableEdges = customizableEdges22;
			...
			btn_Reset.ShadowDecoration.CustomizableEdges = customizableEdges23;
			...
			// btn_Them
			// 
			btn_Them.CustomizableEdges = customizableEdges24;
			...
			btn_Them.ShadowDecoration.CustomizableEdges = customizableEdges25;
			...
			// btn_Capnhat
			// 
			btn_Capnhat.CustomizableEdges = customizableEdges26;
			...
			dgv_danhsachkh.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
			...
			dgv_danhsachkh.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle2;
			dgv_danhsachkh.ColumnHeadersHeight = 4;
			dgv_danhsachkh.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.EnableResizing;
			...
			dgv_danhsachkh.DefaultCellStyle = dataGridViewCellStyle3;
			dgv_danhsachkh.GridColor = Color.FromArgb(231, 229, 255);
			dgv_danhsachkh.Location = new Point(5, 28);
			dgv_danhsachkh.Margin = new Padding(3, 2, 3, 2);
			dgv_danhsachkh.Name = "dgv_danhsachkh";
			dgv_danhsachkh.RowHeadersVisible = false;
			dgv_danhsachkh.RowHeadersWidth = 51;
			dgv_danhsachkh.RowTemplate.Height = 29;
			dgv_danhsachkh.Size = new Size(641, 556);
			dgv_danhsachkh.TabIndex = 0;
			dgv_danhsachkh.ThemeStyle.AlternatingRowsStyle.BackColor = Color.White;
			dgv_danhsachkh.ThemeStyle.AlternatingRowsStyle.Font = null;
			dgv_danhsachkh.ThemeStyle.AlternatingRowsStyle.ForeColor = Color.Empty;
			dgv_danhsachkh.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.Empty;
			dgv_danhsachkh.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.Empty;
			dgv_danhsachkh.ThemeStyle.BackColor = Color.White;
			dgv_danhsachkh.ThemeStyle.GridColor = Color.FromArgb(231, 229, 255);
			dgv_danhsachkh.ThemeStyle.HeaderStyle.BackColor = Color.FromArgb(100, 88, 255);
			dgv_danhsachkh.ThemeStyle.HeaderStyle.BorderStyle = DataGridViewHeaderBorderStyle.None;
			dgv_danhsachkh.ThemeStyle.HeaderStyle.Font = new Font("Segoe UI", 13.8F, FontStyle.Regular, GraphicsUnit.Point, 0);
			dgv_danhsachkh.ThemeStyle.HeaderStyle.ForeColor = Color.White;
			dgv_danhsachkh.ThemeStyle.HeaderStyle.HeaightSizeMode = DataGridViewColumnHeadersHeightSizeMode.EnableResizing;
			dgv_danhsachkh.ThemeStyle.HeaderStyle.Height = 4;
			dgv_danhsachkh.ThemeStyle.ReadOnly = false;
			dgv_danhsachkh.ThemeStyle.RowsStyle.BackColor = Color.White;
			dgv_danhsachkh.ThemeStyle.RowsStyle.BorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
			dgv_danhsachkh.ThemeStyle.RowsStyle.Font = new Font("Segoe UI", 13.8F, FontStyle.Regular, GraphicsUnit.Point, 0);
			dgv_danhsachkh.ThemeStyle.RowsStyle.ForeColor = SystemColors.HotTrack;
			dgv_danhsachkh.ThemeStyle.RowsStyle.Height = 29;
			dgv_danhsachkh.ThemeStyle.RowsStyle.SelectionBackColor = Color.FromArgb(231, 229, 255);
			dgv_danhsachkh.ThemeStyle.RowsStyle.SelectionForeColor = Color.FromArgb(71, 69, 94);
			// 
			// frm_Customers
			// 
			...
			((System.ComponentModel.ISupportInitialize)dgv_danhsachkh).EndInit();
			ResumeLayout(false);
		}
        ...
        private Guna.UI2.WinForms.Guna2DataGridView dgv_danhsachkh;
